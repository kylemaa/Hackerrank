...
if __name__ == "__main__":
    ...
    generate_error_report(
        error, '/Users/KKyle/Hackerrank/Python-Proficiency/error_message.csv')
    generate_user_report(
        per_user, '/Users/KKyle/Hackerrank/Python-Proficiency/user_statistics.csv')
    sys.exit(0)
...
# Save this file, then run the file by passing the path to syslog.log as a parameter to the script.
    ...
    ./log-analysis-regular-experessions.py syslog.log'
